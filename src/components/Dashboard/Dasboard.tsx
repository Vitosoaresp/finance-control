...
export function Dashboard(props: IDashboadProps) {
  ...
  return (
    <div className="flex gap-8 md:justify-center absolute -top-20 lef-1/2 right-1/2 translate-x-1/2 overflow-x-auto md:overflow-x-visible scroll-smooth w-[85vw] md:w-full">
      <CardDashboard
        type="Entradas"
        value={incoming}
